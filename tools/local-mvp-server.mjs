...
async function renderHome(res) {
  ...
  const appName = "TaskMage";
  const faviconSvg = encodeURIComponent(`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64"><rect width="64" height="64" rx="14" fill="#12635f"/><path d="M14 47h36l-7-8H21z" fill="#f8fafc"/><path d="M22 39 33 8l14 31z" fill="#4c1d95"/><path d="M29 24h8M27 31h13" stroke="#facc15" stroke-width="4" stroke-linecap="round"/><rect x="38" y="30" width="14" height="18" rx="3" fill="#fff7ed"/><path d="m42 36 2 2 4-5M42 43h6" stroke="#12635f" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round"/></svg>`);
...
<main>
  <header class="app-header">
    <div class="brand">
      <svg class="brand-mark" viewBox="0 0 72 72" role="img" aria-label="Palarie de vrajitor peste un checklist incapatanat">
        <rect x="3" y="3" width="66" height="66" rx="16" fill="#12635f"/>
        <path d="M12 53h39l-8-9H21z" fill="#f8fafc"/>
        <path d="M22 44 35 9l16 35z" fill="#4c1d95"/>
        <path d="M29 25h10M27 33h15" stroke="#facc15" stroke-width="4" stroke-linecap="round"/>
        <rect x="42" y="31" width="18" height="24" rx="4" fill="#fff7ed" stroke="#fed7aa"/>
        <path d="m47 39 3 3 5-7M47 48h8" stroke="#12635f" stroke-width="2.5" fill="none" stroke-linecap="round" stroke-linejoin="round"/>
      </svg>
      <div>
        <h1>${appName}</h1>
