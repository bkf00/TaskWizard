...
const brandImagePath = path.resolve("./assets/taskmage-hat.png");
...
<head>
  ...
  <link rel="icon" type="image/png" href="/assets/taskmage-hat.png" />
  <style>
...
<main>
  <header class="app-header">
    <div class="brand">
      <img class="brand-mark" src="/assets/taskmage-hat.png" alt="Palarie de vrajitor cu checklist" />
      <div>
        <h1>${appName}</h1>
...
createServer(async (req, res) => {
  try {
    ...
    if (req.method === "GET" && url.pathname === "/assets/taskmage-hat.png") {
